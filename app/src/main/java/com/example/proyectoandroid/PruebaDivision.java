...
public class PruebaDivision extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prueba_division);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });
        tvCorrectos = findViewById(R.id.etDPCorrectos);
        tvIncorrectos = findViewById(R.id.etDPFallidos);
        tvOper = findViewById(R.id.etDPOper);
    ...
    public void jugar() {
        ...
        String oper = Integer.toString(mul) + " / " + Integer.toString(b) + " = " + num;
        tvOper.setText(oper);
