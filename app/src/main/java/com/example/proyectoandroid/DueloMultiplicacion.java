...
public class DueloMultiplicacion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duelo_multiplicacion);
        ...
        etDSOperA = findViewById(R.id.etDMOperA);
        etDSOperB = findViewById(R.id.etDMOperB);
        etDSCorrectosA = findViewById(R.id.etDMCorrectosA);
        etDSCorrectosB = findViewById(R.id.etDMCorrectosB);
        etDSFallidosA = findViewById(R.id.etDMFallidosA);
        etDSFallidosB = findViewById(R.id.etDMFallidosB);

        botonesA[0] = findViewById(R.id.btnDMRes1A);
        botonesA[1] = findViewById(R.id.btnDMRes2A);
        botonesA[2] = findViewById(R.id.btnDMRes3A);
        botonesA[3] = findViewById(R.id.btnDMRes4A);

        botonesB[0] = findViewById(R.id.btnDMRes1B);
        botonesB[1] = findViewById(R.id.btnDMRes2B);
        botonesB[2] = findViewById(R.id.btnDMRes3B);
        botonesB[3] = findViewById(R.id.btnDMRes4B);
    ...
    private void nuevaRonda() {
        ...
        for (int i = 0; i < 4; i++) {
            respuestas[i] = (i == posCorrecta) ? respuestaCorrecta : rd.nextInt(60) + 1;
    ...
    private void mostrarGanador() {
        ...
        if (correctosA > correctosB) {
            if (correctosA == 10){
                mensajeFinal = "¡" + nombreB + " gana y humilla a "+ nombreA+"!";
            }
            else {
                mensajeFinal = "¡" + nombreB + " gana a "+ nombreA+"!";
            }
        } else if (correctosB > correctosA) {
            if (correctosB == 10){
                mensajeFinal = "¡" + nombreA + " gana y humilla a "+ nombreB+"!";
            }
            else {
                mensajeFinal = "¡" + nombreA + " gana a "+ nombreB+"!";
            }
        } else {
            mensajeFinal = "¡Empate, ninguno gana!";
        }
