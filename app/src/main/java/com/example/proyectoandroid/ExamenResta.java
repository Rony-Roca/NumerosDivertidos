...
public class ExamenResta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_examen_resta);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });
        tvCorrectos = findViewById(R.id.etERCorrectos);
        tvIncorrectos = findViewById(R.id.etERFallidos);
        tvOper = findViewById(R.id.etEROper);
        bRes1 = findViewById(R.id.btnERRes1);
        bRes2 = findViewById(R.id.btnERRes2);
        bRes3 = findViewById(R.id.btnERRes3);
        bRes4 = findViewById(R.id.btnERRes4);
        iniciarJuego();
    }
    ...
    public void jugar(){
        ...
        if (opcion){
            oper = Integer.toString(a) + " - " + " ? = " + Integer.toString(resultado);
