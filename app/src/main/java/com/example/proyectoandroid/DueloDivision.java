...
public class DueloDivision extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duelo_division);
        ...
        etDSOperA = findViewById(R.id.etDDOperA);
        etDSOperB = findViewById(R.id.etDDOperB);
        etDSCorrectosA = findViewById(R.id.etDDCorrectosA);
        etDSCorrectosB = findViewById(R.id.etDDCorrectosB);
        etDSFallidosA = findViewById(R.id.etDDFallidosA);
        etDSFallidosB = findViewById(R.id.etDDFallidosB);

        botonesA[0] = findViewById(R.id.btnDDRes1A);
        botonesA[1] = findViewById(R.id.btnDDRes2A);
        botonesA[2] = findViewById(R.id.btnDDRes3A);
        botonesA[3] = findViewById(R.id.btnDDRes4A);

        botonesB[0] = findViewById(R.id.btnDDRes1B);
        botonesB[1] = findViewById(R.id.btnDDRes2B);
        botonesB[2] = findViewById(R.id.btnDDRes3B);
        botonesB[3] = findViewById(R.id.btnDDRes4B);
