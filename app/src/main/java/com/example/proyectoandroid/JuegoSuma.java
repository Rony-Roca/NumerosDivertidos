...
public class JuegoSuma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_suma);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });
        tvCorrectos = findViewById(R.id.etSCorrectos);
        tvIncorrectos = findViewById(R.id.etSFallidos);
        tvOper = findViewById(R.id.etSOper);
        bRes1 = findViewById(R.id.btnSRes1);
        bRes2 = findViewById(R.id.btnSRes2);
        bRes3 = findViewById(R.id.btnSRes3);
        bRes4 = findViewById(R.id.btnSRes4);
        iniciarJuego();
    }
