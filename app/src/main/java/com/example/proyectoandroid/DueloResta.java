...
public class DueloResta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duelo_resta);
        ...
        etDSOperA = findViewById(R.id.etDROperA);
        etDSOperB = findViewById(R.id.etDROperB);
        etDSCorrectosA = findViewById(R.id.etDRCorrectosA);
        etDSCorrectosB = findViewById(R.id.etDRCorrectosB);
        etDSFallidosA = findViewById(R.id.etDRFallidosA);
        etDSFallidosB = findViewById(R.id.etDRFallidosB);

        botonesA[0] = findViewById(R.id.btnDRRes1A);
        botonesA[1] = findViewById(R.id.btnDRRes2A);
        botonesA[2] = findViewById(R.id.btnDRRes3A);
        botonesA[3] = findViewById(R.id.btnDRRes4A);

        botonesB[0] = findViewById(R.id.btnDRRes1B);
        botonesB[1] = findViewById(R.id.btnDRRes2B);
        botonesB[2] = findViewById(R.id.btnDRRes3B);
        botonesB[3] = findViewById(R.id.btnDRRes4B);
