...
public class JuegoResta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_resta);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });
        tvCorrectos = findViewById(R.id.etRCorrectos);
        tvIncorrectos = findViewById(R.id.etRFallidos);
        tvOper = findViewById(R.id.etROper);
        bRes1 = findViewById(R.id.btnRRes1);
        bRes2 = findViewById(R.id.btnRRes2);
        bRes3 = findViewById(R.id.btnRRes3);
        bRes4 = findViewById(R.id.btnRRes4);
        iniciarJuego();
    }
    ...
    public void jugar(){
        ...
        resultado = a - b;
        String oper = Integer.toString(a) + " - " + Integer.toString(b) + " = ?";
        tvOper.setText(oper);
        pos = rd.nextInt(3)+1;
