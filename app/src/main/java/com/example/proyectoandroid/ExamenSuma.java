...
public class ExamenSuma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_examen_suma);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });
        tvCorrectos = findViewById(R.id.etESCorrectos);
        tvIncorrectos = findViewById(R.id.etESFallidos);
        tvOper = findViewById(R.id.etESOper);
        bRes1 = findViewById(R.id.btnESRes1);
        bRes2 = findViewById(R.id.btnESRes2);
        bRes3 = findViewById(R.id.btnESRes3);
        bRes4 = findViewById(R.id.btnESRes4);
        iniciarJuego();
    }
