...
public class JuegoDivision extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_juego_division);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });
        tvCorrectos = findViewById(R.id.etDCorrectos);
        tvIncorrectos = findViewById(R.id.etDFallidos);
        tvOper = findViewById(R.id.etDOper);
        bRes1 = findViewById(R.id.btnDRes1);
        bRes2 = findViewById(R.id.btnDRes2);
        bRes3 = findViewById(R.id.btnDRes3);
        bRes4 = findViewById(R.id.btnDRes4);
        iniciarJuego();
    }
    ...
    public void jugar(){
        ...
        int a, b, pos, r1, r2, r3, r4, mul;
        Random rd = new Random();
        a = rd.nextInt(10)+1;
        b = rd.nextInt(10)+1;
        mul = a * b;
        resultado = mul / b;
        String oper = Integer.toString(mul) + " / " + Integer.toString(b) + " = ?";
        tvOper.setText(oper);
        pos = rd.nextInt(3)+1;
