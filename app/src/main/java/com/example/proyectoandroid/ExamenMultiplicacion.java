...
public class ExamenMultiplicacion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_examen_multiplicacion);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            Insets systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars());
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom);
            return insets;
        });
        tvCorrectos = findViewById(R.id.etEMCorrectos);
        tvIncorrectos = findViewById(R.id.etEMFallidos);
        tvOper = findViewById(R.id.etEMOper);
        bRes1 = findViewById(R.id.btnEMRes1);
        bRes2 = findViewById(R.id.btnEMRes2);
        bRes3 = findViewById(R.id.btnEMRes3);
        bRes4 = findViewById(R.id.btnEMRes4);
        iniciarJuego();
    }
    ...
    public void jugar(){
        ...
        if (opcion){
            oper = Integer.toString(a) + " X " + " ? = " + Integer.toString(resultado);
            numsecret = Integer.toString(b);
            num = b;
        } else {
            oper = " ? " + " X " + Integer.toString(b) + " = " + Integer.toString(resultado);
            numsecret = Integer.toString(a);
            num = a;
        }
        tvOper.setText(oper);
        pos = rd.nextInt(3)+1;
